...
public class Product_Operations {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		Products type1 = new Products("101b", "Laptop", 54000, "Brand-Dell corei7,Model-4245b, RAM-8gb,HDD-1tb",
				"electronics", 5);
		Products type2 = new Products("101w", "Laptop", 52000, "Brand-Dell corei7,Model-4245w, RAM-8gb,HDD-1tb",
				"electronics", 10);
		...
		try {
			ss.purchase_items(v1.getVendor_id(), c1.getCustomer_id(), selected_items);
		} catch (Exception e) {
